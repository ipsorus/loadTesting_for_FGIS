...
for n in range(NUMBER_OF_XML):
    ...
    with open (FileFullPath, 'a', encoding='utf-8') as sample_body:
        ...
        for i in range(NUMBER_OF_RESULT):
            ...
            certNum = 'СВ/' + str(NUMBER_OF_RESULT) + '/' + str(i + 1) + '/' + str(random.randint(1, 650)) + str(random.randint(1, 500)) + str(i)              #Номер свидетельства/извещения о непригодности СИ

            manufactureNum = str(NUMBER_OF_RESULT) + "/" + str(i + 1) + '/' + str(random.randint(1, 999) + random.randint(1, 99)) + str(random.randint(0, i))  #Заводской номер СИ
            manufactureYear = random.randint(2010, 2020)                                                                                                       #Дата производства СИ
            ...
            if means_of_verification == 1:
                ...
                uve_number_1 = f'<gost:number>1.3.ZБО.0065.2012</gost:number>\n'
            ...
            if means_of_verification == 2:
                ...
                se_start = f'<gost:se>\n'
                typeNum = f'<gost:typeNum>ГСО 10000-2011</gost:typeNum>\n'
            ...
            if means_of_verification == 3:
                ...
                mieta_number = f'<gost:number>10009.85.РЭ.00121</gost:number>\n'
            ...
            if means_of_verification == 4:
                ...
                mieta_manufactureNum = f'<gost:manufactureNum>32312313</gost:manufactureNum>\n'
                mi_close = f'</gost:mi>\n'
            ...
            additional_info = f'<gost:additional_info>Поверка из заявки на {NUMBER_OF_RESULT} записей</gost:additional_info>\n'
